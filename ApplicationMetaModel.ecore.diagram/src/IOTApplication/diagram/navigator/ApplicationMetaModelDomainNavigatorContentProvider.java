 ...
 * @generated
 */
public class ApplicationMetaModelDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ApplicationMetaModelDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof IOTApplication.diagram.navigator.ApplicationMetaModelDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier
							.getChildren(((IOTApplication.diagram.navigator.ApplicationMetaModelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result
						.add(new IOTApplication.diagram.navigator.ApplicationMetaModelDomainNavigatorItem(
