 ...
 * @generated
 */
public class ApplicationMetaModelViewProvider extends AbstractProvider
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = IOTApplication.diagram.part.ApplicationMetaModelVisualIDRegistry
		...
		return IOTApplication.diagram.edit.parts.PersonEditPart.VISUAL_ID == visualID
				|| IOTApplication.diagram.edit.parts.ThingEditPart.VISUAL_ID == visualID
				|| IOTApplication.diagram.edit.parts.RoomEditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram
				.setType(IOTApplication.diagram.edit.parts.AppSystemEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case IOTApplication.diagram.edit.parts.PersonEditPart.VISUAL_ID:
			return createPerson_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case IOTApplication.diagram.edit.parts.ThingEditPart.VISUAL_ID:
			return createThing_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case IOTApplication.diagram.edit.parts.RoomEditPart.VISUAL_ID:
			return createRoom_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case IOTApplication.diagram.edit.parts.PersonLocateEditPart.VISUAL_ID:
			return createPersonLocate_4004(containerView, index, persisted,
					preferencesHint);
		case IOTApplication.diagram.edit.parts.ThingLocationEditPart.VISUAL_ID:
			return createThingLocation_4003(containerView, index, persisted,
					preferencesHint);
		case IOTApplication.diagram.edit.parts.ThingOwnerEditPart.VISUAL_ID:
			return createThingOwner_4001(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createPerson_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node
				.setType(IOTApplication.diagram.part.ApplicationMetaModelVisualIDRegistry
		...
		Node label5008 = createLabel(
				node,
				IOTApplication.diagram.part.ApplicationMetaModelVisualIDRegistry
						.getType(IOTApplication.diagram.edit.parts.PersonPidEditPart.VISUAL_ID));
		Node label5009 = createLabel(
				node,
				IOTApplication.diagram.part.ApplicationMetaModelVisualIDRegistry
						.getType(IOTApplication.diagram.edit.parts.PersonGroupEditPart.VISUAL_ID));
		Node label5010 = createLabel(
				node,
				IOTApplication.diagram.part.ApplicationMetaModelVisualIDRegistry
						.getType(IOTApplication.diagram.edit.parts.PersonOfficeEditPart.VISUAL_ID));
		Node label5011 = createLabel(
				node,
				IOTApplication.diagram.part.ApplicationMetaModelVisualIDRegistry
						.getType(IOTApplication.diagram.edit.parts.PersonGenderEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createThing_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node
		...
		Node label5012 = createLabel(
				node,
				IOTApplication.diagram.part.ApplicationMetaModelVisualIDRegistry
						.getType(IOTApplication.diagram.edit.parts.ThingTidEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createRoom_2005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node
		...
		Node label5006 = createLabel(
				node,
				IOTApplication.diagram.part.ApplicationMetaModelVisualIDRegistry
						.getType(IOTApplication.diagram.edit.parts.RoomTemperatureEditPart.VISUAL_ID));
		Node label5007 = createLabel(
				node,
				IOTApplication.diagram.part.ApplicationMetaModelVisualIDRegistry
						.getType(IOTApplication.diagram.edit.parts.RoomBrightnessEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Edge createPersonLocate_4004(View containerView, int index,
	 ...
	 * @generated
	 */
	public Edge createThingLocation_4003(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createThingOwner_4001(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	...
	private void stampShortcut(View containerView, Node target) {
		if (!IOTApplication.diagram.edit.parts.AppSystemEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put(
							"modelID", IOTApplication.diagram.edit.parts.AppSystemEditPart.MODEL_ID); //$NON-NLS-1$
