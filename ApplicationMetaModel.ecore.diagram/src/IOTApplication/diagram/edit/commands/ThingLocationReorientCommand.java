 ...
 * @generated
 */
public class ThingLocationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ThingLocationReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof IOTApplication.Room && newEnd instanceof IOTApplication.Thing)) {
			return false;
		}
		return IOTApplication.diagram.edit.policies.ApplicationMetaModelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistThingLocation_4003(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return IOTApplication.diagram.edit.policies.ApplicationMetaModelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistThingLocation_4003(getOldSource(), getNewTarget());
	}
