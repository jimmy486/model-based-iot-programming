...
/**
 * This is the item provider adapter for a {@link RFID.Sensor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SensorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sensor_sid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_sid_feature", "_UI_Sensor_type"),
				 RFIDPackage.Literals.SENSOR__SID,
				 true,
				 false,
				 false,
	...
	protected void addTemperaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sensor_temperature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_temperature_feature", "_UI_Sensor_type"),
				 RFIDPackage.Literals.SENSOR__TEMPERATURE,
				 true,
				 false,
				 false,
	...
	protected void addBrightnessPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sensor_brightness_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_brightness_feature", "_UI_Sensor_type"),
				 RFIDPackage.Literals.SENSOR__BRIGHTNESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Sensor_type") + " " + sensor.getSid();
	}
