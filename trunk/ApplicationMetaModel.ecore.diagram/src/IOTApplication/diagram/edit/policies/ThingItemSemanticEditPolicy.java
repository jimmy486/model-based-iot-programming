 ...
 * @generated
 */
public class ThingItemSemanticEditPolicy
		extends
	 ...
	 * @generated
	 */
	public ThingItemSemanticEditPolicy() {
		super(
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (IOTApplication.diagram.part.ApplicationMetaModelVisualIDRegistry
					.getVisualID(outgoingLink) == IOTApplication.diagram.edit.parts.ThingLocationEditPart.VISUAL_ID) {
			...
			if (IOTApplication.diagram.part.ApplicationMetaModelVisualIDRegistry
					.getVisualID(outgoingLink) == IOTApplication.diagram.edit.parts.ThingOwnerEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (IOTApplication.diagram.providers.ApplicationMetaModelElementTypes.ThingOwner_4001 == req
				.getElementType()) {
			return getGEFWrapper(new IOTApplication.diagram.edit.commands.ThingOwnerCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case IOTApplication.diagram.edit.parts.ThingOwnerEditPart.VISUAL_ID:
			return getGEFWrapper(new IOTApplication.diagram.edit.commands.ThingOwnerReorientCommand(
					req));
		}
