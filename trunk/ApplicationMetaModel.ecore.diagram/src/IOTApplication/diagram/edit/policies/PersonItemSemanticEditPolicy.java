	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (IOTApplication.diagram.part.ApplicationMetaModelVisualIDRegistry
					.getVisualID(incomingLink) == IOTApplication.diagram.edit.parts.ThingOwnerEditPart.VISUAL_ID) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (IOTApplication.diagram.part.ApplicationMetaModelVisualIDRegistry
					.getVisualID(outgoingLink) == IOTApplication.diagram.edit.parts.PersonLocateEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
