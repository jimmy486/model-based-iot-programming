 ...
 * @generated
 */
public class ApplicationMetaModelNavigatorActionProvider extends
	...
	private class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(
					IOTApplication.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof IOTApplication.diagram.navigator.ApplicationMetaModelNavigatorItem) {
					selectedElement = ((IOTApplication.diagram.navigator.ApplicationMetaModelNavigatorItem) selectedElement)
							.getView();
