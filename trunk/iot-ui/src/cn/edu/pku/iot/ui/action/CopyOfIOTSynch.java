...
//					);
//
//				// validate time for java
////				RFIDSystemImpl mysys = (RFIDSystemImpl) root;
////				AppSystemImpl myapp = (AppSystemImpl) appRes.getContents().get(0);
////				long start1 = System.currentTimeMillis();
////				reader2RoomPerson(mysys, myapp);
...
//					);
//				
//				// validate time for qvt
////				long start2 = System.currentTimeMillis();
//				Resource result = trans.forward(sysRes,appRes);
////				long time2 = System.currentTimeMillis() - start2;
//				
//				// write object stream
////				RFIDSystemImpl mysys = (RFIDSystemImpl) sysRes.getContents().get(0);
////				AppSystemImpl myapp = (AppSystemImpl) result.getContents().get(0);
////				try
////				{
////					ObjectOutputStream output = new ObjectOutputStream(new FileOutputStream("E:\\实验室工作\\Internet of Things\\workspace\\eclipse\\workspace\\validate\\system"));
////					output.writeObject(mysys);
////					output.close();
////					output = new ObjectOutputStream(new FileOutputStream("E:\\实验室工作\\Internet of Things\\workspace\\eclipse\\workspace\\validate\\application"));
////					output.writeObject(myapp);
////					output.close();
////				}
////				catch(Exception e)
////				{
...
//				
//				// excute qvt on model
////				EObject appRoot=result.getContents().iterator().next();
////				
////				String rulePath=RESOURCE_HEAD+"/iot/rule/IOTTrans.qvto";
////				
////				QueryExecutor executor=new QueryExecutor(rulePath, appRoot);
////				executor.doQueryWithoutResult();
////				
////				result.setURI(URI.createURI(RESOURCE_HEAD+"/iot/Res.iotapplication"));
////				result.save(Collections.EMPTY_MAP);
////				result.save(System.out,Collections.EMPTY_MAP);
//				
////				System.out.println("java转换时间为：" + time1 + "ms");
////				System.out.println("QVT转换时间为：" + time2 + "ms");
